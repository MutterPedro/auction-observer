...
public class Main {
	...
	public static void main(String[] args) {
		...
		int times = 0;
		int winner = 0;
		double bid = 0.0,finalBid = initialBid;
		while(times < 3){
			for(int i=0;i<NUM_BIDDERS;i++){
			...
			times++;
			System.out.println("Dou-lhe "+times);
		}
		System.out.println(item+" vendido ao comprador número "+winner+" por "+finalBid+" reais.");
